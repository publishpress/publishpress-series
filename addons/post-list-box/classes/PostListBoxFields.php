    ...
    private static function get_content_fields()
    {
        return [
            ...
            'show_series_order_number' => [
                ...
                'sanitize' => 'absint',
                'default' => 0,
                'description' => __('Show the series order number next to each post title.', 'organize-series'),
                'depends_on' => 'show_post_titles',
                'depends_value' => '1',
            ],
            'series_order_number_position' => [
                'label' => __('Series Order Number Position', 'organize-series'),
                'type' => 'select',
                'tab' => 'item',
                'options' => [
                    'before_title' => __('Before the title', 'organize-series'),
                    'after_title' => __('After the title', 'organize-series'),
                ],
                'sanitize' => 'sanitize_text_field',
                'default' => 'before_title',
                'description' => __('Choose where the order number appears relative to the title.', 'organize-series'),
                'depends_on' => 'show_series_order_number',
                'depends_value' => '1',
            ],
            'post_title_color' => [
            ...
            'show_post_summary' => [
                'label' => __('Show Post Summary', 'organize-series'),
                'type' => 'checkbox',
                'tab' => 'item',
                'sanitize' => 'sanitize_text_field',
                'default' => 0,
            ...
            'summary_length' => [
                'label' => __('Summary Length (words)', 'organize-series'),
                'type' => 'number',
                'tab' => 'item',
                'min' => 10,
                'max' => 500,
            ...
            'summary_color' => [
                'label' => __('Summary Color', 'organize-series'),
                'type' => 'color',
                'tab' => 'item',
                'sanitize' => 'sanitize_hex_color',
                'default' => '#666666',
