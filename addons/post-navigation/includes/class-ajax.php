...
class PPS_Series_Post_Navigation_Ajax
{
    ...
    public static function import_layout()
    {
        ...
        if (! $post_id || ! $post || $post->post_type !== PPS_Series_Post_Navigation_Utilities::POST_TYPE || ! current_user_can('edit_post', $post_id) || empty($settings)) {
        ...
        update_post_meta($post_id, PPS_Series_Post_Navigation_Utilities::META_PREFIX . 'layout_meta_value', $sanitized_settings);
