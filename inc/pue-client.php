	...
	class PluginUpdateEngineChecker {
		...
		public function deprecatedNotice()
		{
            ...
            <div class="notice error">
                ...
                <p>
                    The new fields for your license keys is found in the sidebar on this page, labelled "Extension Licenses".  This notice will disappear once all of your Organize Series add-ons have been updated.
                </p>
            </div>
			<?php
		}
