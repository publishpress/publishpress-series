...
{
    return [
        'meta_value' => 'orgmeta.meta_value+ 0', // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_value -- This is an allowlist of sort fragments, not a meta query.
        'post_date'  => 'post_date',
    ];
}
...
function ppseries_maybe_migrate_taxonomy_terms()
{
    ...
    $raw_new  = isset($_POST['org_series_options']['series_taxonomy_slug'])
        ? sanitize_text_field(wp_unslash($_POST['org_series_options']['series_taxonomy_slug']))
        : '';
