 ...
 */
// phpcs:disable WordPress.Security.NonceVerification.Missing -- Called only from orgseries_validate() after Settings API nonce and capability checks.
function ppseries_maybe_migrate_taxonomy_terms()
{
    ...
    $raw_new  = isset($_POST['org_series_options']['series_taxonomy_slug'])
        ? trim(sanitize_text_field(wp_unslash($_POST['org_series_options']['series_taxonomy_slug'])))
        : '';
