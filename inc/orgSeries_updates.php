    ...
    class PluginUpdateChecker
    {
        ...
        **/
        ...
        function display_json_error()
        {
            ...
            <script type="text/javascript">
                function OrgSeriesDismissUpgrade(){
                    ...
                    jQuery.post(ajaxurl, {action:"<?php echo esc_attr($this->dismiss_upgrade); ?>", version:"<?php echo esc_attr($pluginInfo->version); ?>", nonce:"<?php echo esc_attr(wp_create_nonce($this->dismiss_upgrade)); ?>"});
                }
            </script>
                <?php
            }
        ...
        function dashboard_dismiss_upgrade()
        {
            ...
            if (!current_user_can('update_plugins') || !isset($_POST['version']) || !is_string($_POST['version'])) {
                wp_die(-1, 403);
            }
            ...
            $os_ary[] = sanitize_text_field(wp_unslash($_POST['version']));
