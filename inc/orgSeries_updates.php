...
class PluginUpdateChecker {
	...
	**/
	function set_api($new_api = '') {
		...
		//todo need to get the install key and add it into the query
	...
	function display_json_error() {
		...
		if ( version_compare($pluginInfo->version, $this->getInstalledVersion(), '>') ) {
			...
			if ( $pluginInfo->api_invalid = true ) {
...
class PluginInfo {
	...
	public static function fromJson($json){
		...
		$info = new PluginInfo();
		//TODO -> this is where I could filter the response and remove anything that references the install key if that gets returned (due to there being a new key generated byt he server backend part).
