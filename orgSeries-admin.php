...
global $post, $postdata, $content, $orgseries;
	...
	<p id="jaxseries"></p>
		...
		<input type="text" name="serie_post_shorttitle[<?php echo isset($ser_id[0]) ? $ser_id[0] : 0; ?>]" id="serie_post_shorttitle" size="40" value="<?php echo get_post_meta($id, SPOST_SHORTTITLE_KEY, true); ?>"/>
