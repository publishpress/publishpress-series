		...
		<div class="postbox-container" style="width: 99%;line-height:normal;">
			<div id="topic-toc-settings-series-template-core" class="postbox" style="line-height:normal;">
				<div class="inside" style="padding: 10px;">
					...
					<br />
					<input name="<?php echo $org_name; ?>[series_nextpost_nav_custom_text]" id="series_nextpost_nav_custom_text" type="text" value="<?php echo $org_opt['series_nextpost_nav_custom_text']; ?>" size="40" /> <?php _e('Custom Next Post Text (if this is left blank, the post title will be used)', 'organize-series'); ?><br />
					<input name="<?php echo $org_name; ?>[series_prevpost_nav_custom_text]" id="series_prevpost_nav_custom_text" type="text" value="<?php echo $org_opt['series_prevpost_nav_custom_text']; ?>" size="40" /> <?php _e('Custom previous post navigation text. (if this is left blank, the post title will be used)', 'organize-series'); ?><br />
					<br />
