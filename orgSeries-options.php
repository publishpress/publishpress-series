...
function orgseries_validate($input) {
	...
	if ( $input['reset_option'] == 1 ) {
		...
		if ($reset_options = $orgseries->add_settings(true)) {
			...
			$update['updated_output'] = '<div class="updated"><p>'. __('Organize Series Plugin Options have been RESET',$orgseries->org_domain).'</p></div>';
	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
		<div id="side-info-column" class="inner-sidebar">
			...
			<div id="token-legend" class="postbox">
				...
				<div class="inside">
					<p><small><?php _e('The following is a legend of the tokens that are available for use in the custom template fields. These will be replaced with the appropriate values when the plugin runs.', $orgseries->org_domain); ?></small></p>
					<strong>%series_icon%</strong><br />
						<em><?php _e('This will be replaced with the series icon for a series.', $orgseries->org_domain); ?></em><br /><br />
					<strong>%series_icon_linked%</strong><br />
						<em><?php _e('Same as %series_icon% except that the series icon will be linked to the series page',$orgseries->org_domain); ?></em><br /><br />
					<strong>%series_list%</strong><br />
						<em><?php _e('This token is for use with the orgSeries widget only - it references where you want the list of series titles to be inserted and requires that the template for each series title be also set.', $orgseries->org_domain); ?></em><br /><br />
					<strong>%series_title%</strong><br />
						<em><?php _e('This will be replaced with the title of a series', $orgseries->org_domain); ?></em><br /><br />
					<strong>%series_title_linked%</strong><br />
						<em><?php _e('Same as %series_title% except that it will also be linked to the series page', $orgseries->org_domain); ?></em><br /><br />
					<strong>%post_title_list%</strong><br />
						<em><?php _e('Is the location token for where the contents of the post list post templates will appear.', $orgseries->org_domain); ?></em><br /><br />
					<strong>%post_title%</strong><br />
						<em><?php _e('Will be replaced with the post title of a post in the series', $orgseries->org_domain); ?></em><br /><br />
					...
					<strong>%series_part%</strong><br />
						<em><?php _e('Will display what part of a series the post is', $orgseries->org_domain); ?></em><br /><br />
					<strong>%total_posts_in_series%</strong><br />
						<em><?php _e('Will display the total number of posts in a series', $orgseries->org_domain); ?></em><br /><br />
					<strong>%series_description%</strong><br />
						<em><?php _e('Will display the description for the series', $orgseries->org_domain); ?></em>
		...
		<div id="post-body" class="has-sidebar">
			<div id="post-body-content" class="has-sidebar-content">
				...
				<br />
				<?php 
				//$submit_text = __('Do you really want to reset to default options (all your custom changes will be lost)?', $orgseries->org_domain); 
				...
				<span class="submit">
					...
					<input type="submit" name="update_orgseries" value="<?php _e('Update Options', $orgseries->org_domain); ?>" />
					<input type="submit" name="option_reset" value="<?php _e('Reset options to default', $orgseries->org_domain); ?>" />
				</span>
				</form>
...
function orgseries_main_section() {
	global $orgseries;
	?>
	<p><?php _e('Choose from the following options for turning on or off automatic insertion of template tags for Organize Series into your blog.  If you wish to have more control over the location of the template tags (you power user you) then deselect as needed.', $orgseries->org_domain); ?></p>
	<?php
}
...
function orgseries_icon_section() {
	global $orgseries;
	?>
	<p><?php _e('This section is for setting the series icon options (note if you do not include one of the %tokens% for series icon in the template settings section then series-icons will not be displayed. All images for series-icons will upload into your default wordpress upload directory.', $orgseries->org_domain); ?></p>
	<?php
}
	...
	<div class="metabox-holder">	
		<div class="postbox-container" style="width: 99%;line-height:normal;">
			<div id="topic-toc-settings-automation-core" class="postbox" style="line-height:normal;">
					...
					<input name="<?php echo $org_name; ?>[auto_tag_seriesmeta_toggle]" id="auto_tag_seriesmeta_toggle" type="checkbox" value="1" <?php checked('1', $org_opt['auto_tag_seriesmeta_toggle']); ?> /> <?php _e('Display series meta information with posts?', $orgseries->org_domain); ?>
					<small><em><?php _e('Series meta will include whatever is listed in the Template tag options for the series meta tag (see settings on this page). [default = selected]', $orgseries->org_domain); ?></em></small><br /><br />
					<input name="<?php echo $org_name; ?>[custom_css]" id="custom_css" type="checkbox" value="1" <?php checked('1', $org_opt['custom_css']); ?> /> <?php _e('Use custom .css?', $orgseries->org_domain); ?>
					<small><em><?php _e('Leaving this box checked will make the plugin use the included .css file.  If you uncheck it you will need to add styling for the plugin in your themes "style.css" file. [default = checked]', $orgseries->org_domain); ?></em></small>
					<br />
					<br />
					...
					<small><em><?php _e('Set what you want to use as the base for referring to your series structure in permalinks series archive pages. NOTE: This ONLY applies when you have "Permalinks" enabled in WordPress', $orgseries->org_domain); ?></em></small><br /><br />
					<strong><?php _e('Series Table of Contents Title:', $orgseries->org_domain); ?></strong><input type="text" name="<?php echo $org_name; ?>[series_toc_title]" value="<?php echo htmlspecialchars($org_opt['series_toc_title']); ?>" style="width:300px;"/><br />
					<small><em><?php _e('Enter what you want to appear in the browser title when readers are viewing the series table of contents page.', $orgseries->org_domain); ?></em></small><br /> <br />
					<input name="<?php echo $org_name; ?>[series_posts_orderby]" id="series_posts_orderby_part" type="radio" value="meta_value" <?php checked('meta_value', $org_opt['series_posts_orderby']); ?> /><?php _e('order by series part', $orgseries->org_domain); ?>
					<input name="<?php echo $org_name; ?>[series_posts_orderby]" id="series_posts_orderby_date" type="radio" value="post_date" <?php checked('post_date', $org_opt['series_posts_orderby']); ?> /><?php _e('Order by date', $orgseries->org_domain); ?>
					<br />
					<input name="<?php echo $org_name; ?>[series_posts_order]" id="series_posts_order_ASC" type="radio" value="ASC" <?php checked('ASC', $org_opt['series_posts_order']); ?> /><?php _e('Ascending', $orgseries->org_domain); ?>
					<input name="<?php echo $org_name; ?>[series_posts_order]" id="series_posts_order_DESC" type="radio" value="DESC" <?php checked('DESC', $org_opt['series_posts_order']); ?> /><?php _e('Descending', $orgseries->org_domain); ?>
					<br />
					<small><em><?php _e('You can choose what order you want the posts on a series archive page to be displayed.  Default is by date, descending.', $orgseries->org_domain); ?></em></small>
					<br />
					<br />
	...
	<div class="metabox-holder">	
		<div class="postbox-container" style="width: 99%;line-height:normal;">
			<div id="topic-toc-settings-series-template-core" class="postbox" style="line-height:normal;">
				<div class="inside" style="padding: 10px;">
					<strong><?php _e('Series Post List Template:', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('This affects the list of series in a post on the page of a post belonging to a series [template tag -> wp_postlist_display()]', $orgseries->org_domain); ?></small><br />
					...
					<br />
					<strong><?php _e('Series Post List Post Title Template:', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('Use this to indicate what html tags will surround the post title in the series post list.', $orgseries->org_domain); ?></small><br/>
					...
					<br />
					<strong><?php _e('Series Post List Current Post Title Template:', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('Use this to style how you want the post title in the post list that is the same as the current post to be displayed.', $orgseries->org_domain); ?></small><br />
					...
					<br />
					<strong><?php _e('Series Post Navigation Template:', $orgseries->org_domain); ?></strong><br />
					...
					<br />
					<strong><?php _e('Series Meta:', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('This will control how and what series meta information is displayed with posts that are part of a series. [template tag -> wp_seriesmeta_write()]', $orgseries->org_domain); ?></small><br />
					...
					<br />
					<strong><?php _e('Series Meta (with excerpts):', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('This will control how and what series meta information is displayed with posts that are part of a series when the_excerpt is called. [template tag -> wp_seriesmeta_write(true)]', $orgseries->org_domain); ?></small><br />
					...
					<br />
					<strong><?php _e('Latest Series (tags before):', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('Put here any html you want before latest series information NOTE: series template tokens WILL NOT be converted here.', $orgseries->org_domain); ?></small><br />
					...
					<br />
					<strong><?php _e('Latest Series (inner tags):', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('This will control the layout/style and contents that will be returned with the latest_series() template tag (both via widget and/or manual calls).  NOTE: Organize Series %tokens% can be used in this field.', $orgseries->org_domain); ?></small><br />
					...
					<br />
					<strong><?php _e('Latest Series (tags after):', $orgseries->org_domain); ?></strong><br />
					<small><?php _e('Put here any html you want after latest series information NOTE: series template tokens WILL NOT be converted here.', $orgseries->org_domain); ?></small><br />
...
function series_icon_core_fieldset() {
	...
	<div class="postbox-container" style="width: 99%;line-height:normal;">
		<div id="topic-toc-settings-icon-core" class="postbox" style="line-height:normal;">
			<div class="inside" style="padding: 10px;">
				<input name="<?php echo $org_name;?>[series_icon_width_series_page]" id="series_icon_width_series_page" type="text" value="<?php echo $org_opt['series_icon_width_series_page']; ?>" size="10" /> <?php _e('Width for icon on series table of contents page (in pixels).', $orgseries->org_domain); ?>
				<br />
				<input name="<?php echo $org_name;?>[series_icon_width_post_page]" id="series_icon_width_post_page" type="text" value="<?php echo $org_opt['series_icon_width_post_page']; ?>" size="10" /> <?php _e('Width for icon on a post page (in pixels).', $orgseries->org_domain); ?>
				<br />	
				<input name="<?php echo $org_name;?>[series_icon_width_latest_series]" id="series_icon_width_latest_series" type="text" value="<?php echo $org_opt['series_icon_width_latest_series']; ?>" size="10" /> <?php _e('Width for icon if displayed via the latest series template (in pixels).', $orgseries->org_domain); ?>
			</div>
		</div>
	</div>
	</div>
