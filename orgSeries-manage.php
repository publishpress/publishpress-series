...
function wp_insert_series($series_id, $taxonomy_id)
{
    ...
    $series_icon = isset($_POST['series_icon_loc']) ? sanitize_text_field(wp_unslash($_POST['series_icon_loc'])) : null;
...
{
    global $_POST, $wpdb;
    $series_icon_loc = isset($_POST['series_icon_loc']) ? sanitize_text_field(wp_unslash($_POST['series_icon_loc'])) : '';
    ...
    <tr class="form-field">
        ...
        <input name="term_order" id="term_order" type="text" value="<?php echo $series->term_order; ?>" size="11" />
            ...
            <tr valign="top">
                ...
                <th scope="row"><?php esc_html_e('Current series featured image:', 'organize-series'); ?></th><?php
                } ?>
                <td>
                    <?php if ($series_icon != '') {
...
function ajax_pp_series_reordering_terms()
{
    ...
    $terms = array_map('sanitize_text_field', wp_unslash($_POST['terms']));
