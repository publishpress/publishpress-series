...
class Container
{
    ...
    public function __construct(PimpleContainer $pimple)
    {
        ...
        $this->container[IncomingRequest::class]           = function ($container) {
            return new IncomingRequest($_GET, $_POST, $_COOKIE); // phpcs:ignore WordPress.Security.NonceVerification.Missing, WordPress.Security.NonceVerification.Recommended, WordPressVIPMinimum.Variables.RestrictedVariables.cache_constraints___COOKIE -- Request object construction only; handlers validate nonce before writes.
        };
