...
class PluginUpdater
{
    ...
    public function __construct($_api_url, $_plugin_file, $_api_data = null)
    {
        ...
        $this->cache_key   = md5(wp_json_encode(array($this->slug, $this->api_data['license'], $this->beta)));
    ...
    public function plugins_api_filter($_data, $_action = '', $_args = null)
    {
        ...
        $cache_key = 'edd_api_request_' . md5(wp_json_encode(array($this->slug, $this->api_data['license'], $this->beta)));
    ...
    {
        // phpcs:disable WordPress.Security.NonceVerification.Recommended -- Read-only changelog request; capability is checked before remote lookup/output.
        ...
        $plugin       = sanitize_key(wp_unslash($_REQUEST['plugin']));
