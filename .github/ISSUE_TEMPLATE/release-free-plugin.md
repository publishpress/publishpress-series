...
- [ ] Monitor [GitHub Actions](https://github.com/publishpress/publishpress-series/actions) and confirm all release and deployment workflows complete successfully
- [ ] Verify the [WordPress.org plugin page](https://wordpress.org/plugins/organize-series/) shows the new version and updated release information
