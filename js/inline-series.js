jQuery(document).ready(function($) {
	...
	inlineEditPost.edit = function( id ) {
		...
		rowData = $('#inline_series_'+$post_id);
		post_id = $('.series_post_id', rowData).text();

		$('#hidden_series_id', 'div.inline_edit_series_old').remove();
		$('div.inline_edit_series_old').attr('class', 'inline_edit_series_');
		$('div.inline_edit_series_').attr('class','inline_edit_series_'+post_id);
		editRowData = $('.inline_edit_series_'+post_id);
